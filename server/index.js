...
// XES: Change to original with express 3 to expres 4 (use http://expressjs.com/guide/migrating-4.html)
var logger = require('morgan'); // XES: Change to express4 ---> npm install --save morgan
